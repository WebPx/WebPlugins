...
{
    public abstract class JQueryDataBoundControl : DataBoundControl, IScriptControl, IJQueryControl, ICallbackEventHandler
    {
        public JQueryDataBoundControl()
        {
            this.RequiresForm = true;
            this.ClientObject = true;
        }

        public JQueryDataBoundControl(HtmlTextWriterTag tagKey) : this()
        {
            this._tagKey = tagKey;
        }
